...
export function Sidebar() {
  ...
  return (
    <div className="flex h-full w-64 flex-col bg-zinc-50 border-r border-zinc-200 dark:bg-zinc-950 dark:border-zinc-800">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-white text-blue-600 shadow-sm ring-1 ring-zinc-200 dark:bg-zinc-900 dark:ring-zinc-800 dark:text-blue-400"
